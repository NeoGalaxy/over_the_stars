...
pub const BLOCK_TYPES: [BlockType; 8] = [
	...
	BlockType{name: "diamond_ore", id: 5,
		hp: Some(15), hardness : 20,
		light_level: -2,
		is_solid: true, can_fall: false,
		texture: Some(Color::RGB(0,240,200)),
		outline_texture: Some(Color::RGB(0,210,170)),
		bg_texture: Some(Color::RGB(0,205,165)),
		bg_outline_texture: Some(Color::RGB(0,205,165)),
	},
	BlockType{name: "gold_ore", id: 4,
		hp: Some(15), hardness : 15,
		light_level: -2,
